...
<div class="well container col-lg-6 col-lg-offset-3">
    <div>
        <ul class="nav nav-pills" id="bar">
            ...
            <li><a href="#forceAddCourse">ForceAddCourse</a></li>
            <li class="pull-right">
        ...
        <div class="tab-content" id="tabs">
            ...
            <div id="forceAddCourse" class="tab-pane">
                <div class="col-lg-12">
                    <form class="form-inline col-lg-12" action="<%=root%>/reg/force_select_course" method="get">
                        <input class="form-control" type="text" name="sid" required placeholder="student id*"/>
                        <input class="form-control" type="text" name="cid" required placeholder="course id*"/>
                        <button class="btn" type="submit">Add</button>
                    </form>
                </div>
            </div>
